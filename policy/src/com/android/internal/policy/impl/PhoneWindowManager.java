...
import com.android.internal.util.hyperion.Converter;
    ...
    private final Runnable mDoubleTapTimeoutRunnable = new Runnable() {
        ...
        public void run() {
            if (mHomeDoubleTapPending) {
                ...
                HyperionActions.processAction(mContext, mPressOnHomeBehavior, false);
            }
            if (mMenuDoubleTapPending) {
                ...
                HyperionActions.processAction(mContext, mPressOnMenuBehavior, false);
            }
            if (mBackDoubleTapPending) {
                ...
                HyperionActions.processAction(mContext, mPressOnBackBehavior, false);
            }
            if (mAppSwitchDoubleTapPending) {
                ...
                HyperionActions.processAction(mContext, mPressOnAppSwitchBehavior, false);
            }
            if (mAssistDoubleTapPending) {
                ...
                HyperionActions.processAction(mContext, mPressOnAssistBehavior, false);
            }
        }
    };
    ...
    public long interceptKeyBeforeDispatching(WindowState win, KeyEvent event, int policyFlags) {
        ...
        if (keyCode == KeyEvent.KEYCODE_HOME) {
            ...
            if (down) {
                ...
                if (repeatCount == 0) {
                    ...
                    if (mHomeDoubleTapPending) {
                        ...
                        HyperionActions.processAction(mContext, mDoubleTapOnHomeBehavior, false);
                    }
                } else if (longPress) {
                    if (!keyguardOn
                        ...
                        performHapticFeedbackLw(null, HapticFeedbackConstants.LONG_PRESS, false);
                        HyperionActions.processAction(mContext, mLongPressOnHomeBehavior, false);
                        mHomeConsumed = true;
                    }
                }
            }
            ...
            if (virtualKey && down) {
                ...
                if (repeatCount == 0) {
                    ...
                    if (mMenuDoubleTapPending) {
                        ...
                        HyperionActions.processAction(mContext, mDoubleTapOnMenuBehavior, false);
                        return -1;
                    }
                } else if (longPress) {
                    if (!keyguardOn
                        ...
                        performHapticFeedbackLw(null, HapticFeedbackConstants.LONG_PRESS, false);
                        HyperionActions.processAction(mContext, mLongPressOnMenuBehavior, false);
                        mMenuConsumed = true;
                        return -1;
                    }
                }
            ...
            if (!down && mAppSwitchPressed) {
                ...
                HyperionActions.processAction(mContext,
            ...
            if (down) {
                ...
                if (repeatCount == 0) {
                    ...
                    if (mAppSwitchDoubleTapPending) {
                        ...
                        HyperionActions.processAction(mContext, mDoubleTapOnAppSwitchBehavior, false);
                    }
                } else if (longPress) {
                    if (!keyguardOn
                        ...
                        performHapticFeedbackLw(null, HapticFeedbackConstants.LONG_PRESS, false);
                        HyperionActions.processAction(mContext, mLongPressOnAppSwitchBehavior, false);
                        mAppSwitchConsumed = true;
                    }
                }
            }
            ...
            if (down) {
                ...
                if (repeatCount == 0) {
                    ...
                    if (mAssistDoubleTapPending) {
                        ...
                        HyperionActions.processAction(mContext, mDoubleTapOnAssistBehavior, false);
                    }
                } else if (longPress) {
                    if (!keyguardOn
                        ...
                        performHapticFeedbackLw(null, HapticFeedbackConstants.LONG_PRESS, false);
                        HyperionActions.processAction(mContext, mLongPressOnAssistBehavior, false);
                        mAssistConsumed = true;
                    }
                }
            }
            ...
            if (virtualKey && down) {
                ...
                if (repeatCount == 0) {
                    ...
                    if (mBackDoubleTapPending) {
                        ...
                        HyperionActions.processAction(mContext, mDoubleTapOnBackBehavior, false);
                    }
                } else if (longPress) {
                    if (!keyguardOn
                        ...
                        performHapticFeedbackLw(null, HapticFeedbackConstants.LONG_PRESS, false);
                        HyperionActions.processAction(mContext, mLongPressOnBackBehavior, false);
                        mBackConsumed = true;
                    }
                }
            }
