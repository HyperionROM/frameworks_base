...
package com.android.internal.util.hyperion;
    ...
    public static void processActionWithOptions(Context context,
            ...
            if (action.equals(ButtonsConstants.ACTION_HOME)) {
                ...
                startActivity(context, windowManagerService, isKeyguardShowing, intent);
                    ...
                    Log.e("HyperionActions:", "No activity to handle assist long press action.", e);
                }
                return;
                ...
                try {
                    ...
                    Log.e("HyperionActions:", "URISyntaxException: [" + action + "]");
                    return;
                }
                startActivity(context, windowManagerService, isKeyguardShowing, intent);
                return;
